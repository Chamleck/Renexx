...
describe("Testing of scheduling table", () => {
  ...
  describe("Filters Test", () => {
    it('Original table filters testing', () => {
      ...
      schedulingPage.inputDate('From', '01.06.2023', '3');
      schedulingPage.inputDate('To', '01.06.2023', '3');
      schedulingPage.clickTotalOrders();
      cy.wait(500);
      cy.exist('[data-label="Order Delivery Date"]').then(exists => {
        if (exists) {
          schedulingPage.getRows('Order Delivery Date').then(element => {
            const count = element.length;
            checkData(count, 'Order Delivery Date', '01.06.2023', '01.06.2023');
      ...
      schedulingPage.inputDate('From', '01.06.2023', '4');
      ...
      cy.exist('[data-label="Order Imported Date"]').then(exists => {
        if (exists) {
          schedulingPage.getRows('Order Imported Date').then(element => {
            const count = element.length;
            checkData(count, 'Order Imported Date', '01.06.2023', '01.06.2023');
      ...
      schedulingPage.inputDate('From', '01.06.2023', '5');
      schedulingPage.inputDate('To', '01.06.2023', '5');
      schedulingPage.clickTotalOrders();
      cy.wait(500);
      cy.exist('[data-label="Order Earliest Ship Date"]').then(exists => {
        if (exists) {
          schedulingPage.getRows('Order Earliest Ship Date').then(element => {
            const count = element.length;
            checkData(count, 'Order Earliest Ship Date', '01.06.2023', '01.06.2023');
      ...
      schedulingPage.inputDate('From', '01.06.2023', '6');
      schedulingPage.inputDate('To', '01.06.2023', '6');
      schedulingPage.clickTotalOrders();
      cy.wait(500);
      cy.exist('[data-label="Order Latest Ship Date"]').then(exists => {
        if (exists) {
          schedulingPage.getRows('Order Latest Ship Date').then(element => {
            const count = element.length;
            checkData(count, 'Order Latest Ship Date', '01.06.2023', '01.06.2023');
      ...
      schedulingPage.inputDate('From', '01.06.2023', '7');
      schedulingPage.inputDate('To', '01.06.2023', '7');
      schedulingPage.clickTotalOrders();
      cy.wait(500);
      cy.exist('[data-label="Mail Date To Send"]').then(exists => {
        if (exists) {
          schedulingPage.getRows('Mail Date To Send').then(element => {
            const count = element.length;
            checkData(count, 'Mail Date To Send', '01.06.2023', '01.06.2023');
